<!-- for main -->
<!--
[![Download](https://img.shields.io/badge/Download-v1.5.0-%23007ec6)](https://github.com/tegonal/gt/releases/tag/v1.5.0)
...
Please have a look at the README of the corresponding release/git tag. Latest version: [README of v1.5.0](https://github.com/tegonal/gt/tree/v1.5.0/README.md).
...
currentDir=$(pwd) &&
	...
	wget "https://raw.githubusercontent.com/tegonal/gt/v1.5.0/install.sh" &&
	wget "https://raw.githubusercontent.com/tegonal/gt/v1.5.0/install.sh.sig" &&
...
1. [![Download](https://img.shields.io/badge/Download-v1.5.0-%23007ec6)](https://github.com/tegonal/gt/releases/tag/v1.5.0)
